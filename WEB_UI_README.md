...
```bash
python3 -c "from crate.api import RenamerAPI; print('API OK')"
```
...
1. **DO NOT** modify `crate/api/` or `crate/core/`
2. **DO** add new routes to `web/main.py`
