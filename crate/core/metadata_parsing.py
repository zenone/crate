...
def extract_disc_number(s: str) -> str:
    """
    Extract disc number from string.

    Args:
        s: Disc number string (e.g., "1", "2", "2/3")

    Returns:
        Disc number as string (e.g., "1", "2") or "" if invalid

    Examples:
        >>> extract_disc_number("1")
        '1'
        >>> extract_disc_number("2/3")
        '2'
        >>> extract_disc_number("")
        ''
    """
