...
For concrete examples from shipped projects, see:
- `lessons-upkeep-2026-02.md` - Lessons from shipping Upkeep v2.0.0 (macOS maintenance toolkit)
- `architecture-patterns.md` - Proven patterns distilled from shipped projects (API-first, daemon pattern, preview mode, etc.)

These project-specific lessons contain battle-tested patterns that complement the general guidance above.
